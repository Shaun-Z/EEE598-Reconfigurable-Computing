; ModuleID = '/home/yliu1047/RC/lab2/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16a16struct.ap_uint<8>"([16 x [16 x %"struct.ap_uint<8>"]]* %dst, [16 x [16 x %"struct.ap_uint<8>"]]* readonly %src, i64 %num) local_unnamed_addr #2 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @"arraycpy_hls.p0a16struct.ap_uint<8>"([16 x %"struct.ap_uint<8>"]* %dst.addr, [16 x %"struct.ap_uint<8>"]* %src.addr, i64 16)
...
declare void @matrix_mult_hw_stub([16 x %"struct.ap_uint<8>"]* noalias nocapture nonnull readonly, [16 x %"struct.ap_uint<8>"]* noalias nocapture nonnull readonly, [16 x %"struct.ap_uint<32>"]* noalias nocapture nonnull)
